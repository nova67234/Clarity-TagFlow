...
| 🪄 **Image generation** (Flux · Z-Image Turbo + LoRA) | ✅ | ✅ *(self-installing ComfyUI backend)* |
...
Everything else above already ships in the Rust edition — including in-app image generation (Flux & Z-Image Turbo). 🎉
